...
export default {
  ...
  login: {
    ...
    verificationCode: "Check your email",
    ...
    emailCodeSentMessage: "We sent a 6-digit code to",
    ...
    createAccountMessage: "We couldn't find an account for {email}. Would you like to create one?",
    createAccountConfirm: "Create account",
    passwordRequirements: "Use at least 8 characters, including:\nUppercase · lowercase · number · special character",
    ...
    forgotPasswordCodePlaceholder: "Enter verification code",
    forgotPasswordSendCode: "Send Code",
    forgotPasswordResetButton: "Reset Password",
    forgotPasswordCodeSent: "Verification code sent to your email",
    forgotPasswordSuccess: "Password reset successfully",
    forgotPasswordFailed: "Failed to reset password",
  },
  ...
  error: {
    ...
    AUDIO_READ_FAILED: "Failed to read audio file",
    ...
    microphoneInUse: "Microphone is being used by another app.",
    recordingTooShortAlert: "Recording too short, please record again.",
    recordingFileNotFound: "Recording file not found, please record again.",
